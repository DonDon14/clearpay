...
$routes->get('/review-center', 'Admin\ReviewCenterController::index', ['filter' => 'auth']);
$routes->get('/admin/review-center/pending-count', 'Admin\ReviewCenterController::pendingCount', ['filter' => 'auth']);
...
$routes->delete('/payments/delete/(:num)', 'Admin\PaymentsController::delete/$1', ['filter' => 'auth']);
    ...
    $routes->get('/payments/by-product/(:num)', 'Admin\PaymentsController::byProduct/$1', ['filter' => 'auth']);
    $routes->get('/payments/contribution-history', 'Admin\PaymentsController::contributionHistory', ['filter' => 'auth']);
