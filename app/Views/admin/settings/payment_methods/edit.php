            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="card-title mb-0">
                        ...
                        Edit Payment Method: <?= esc($paymentMethod['name']) ?>
                    </h5>
                </div>
                <div class="card-body">
                    <?= form_open('admin/settings/payment-methods/update/' . $paymentMethod['id'], ['class' => 'needs-validation', 'novalidate' => true]) ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?= session()->getFlashdata('validation_errors.description') ? 'is-invalid' : '' ?>" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Optional description for this payment method"><?= old('description', $paymentMethod['description']) ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="<?= old('account_details', $paymentMethod['account_details']) ?>" 
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-muted mb-0">
                                            <?= date('M j, Y g:i A', strtotime($paymentMethod['created_at'])) ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-muted mb-0">
                                            <?= date('M j, Y g:i A', strtotime($paymentMethod['updated_at'])) ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
