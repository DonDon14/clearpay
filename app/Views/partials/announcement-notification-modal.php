...
function showAnnouncementNotification(announcementData) {
    ...
    document.getElementById('announcementDate').textContent = formatAnnouncementDate(announcementData.created_at);
    document.getElementById('announcementAuthor').textContent = announcementData.author || 'System Administrator';
    document.getElementById('announcementTime').textContent = formatAnnouncementTime(announcementData.created_at);
...
function checkForNewAnnouncements() {
    fetch(window.APP_BASE_URL + 'payer/check-new-announcements')
        .then(response => response.json())
        .then(data => {
            if (data.success && data.announcement) {
                // Check if this announcement was already shown
