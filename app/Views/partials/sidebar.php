            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="<?= base_url('review-center') ?>" class="sidebar-item <?= (($pageTitle ?? '') === 'Review Center') ? 'active' : '' ?>" data-tooltip="Review Center">
                        ...
                        <span class="menu-text">Review Center</span>
                        <span class="notification-badge" id="reviewCenterBadge" style="display: none; background: #ef4444 !important; color: white !important; font-size: 0.75rem !important; font-weight: 600 !important; padding: 2px 6px !important; border-radius: 10px !important; min-width: 18px !important; height: 18px !important; margin-left: auto !important; margin-right: 8px !important; text-decoration: none !important; border: none !important; line-height: 1 !important; flex-shrink: 0 !important;"></span>
                    </a>
                </li>
                <li>
