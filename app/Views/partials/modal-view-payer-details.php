            ...
            <div class="modal-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-12 text-center">
                                <div class="profile-picture-container d-inline-block">
                                    <div class="profile-picture-wrapper ui-profile-picture-shell">
                                        <img id="viewPayerProfilePicture" src="" alt="Profile Picture" class="ui-cover-image d-none">
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center mb-3">
                                <div class="p-3 bg-primary bg-opacity-10 rounded">
                                    <i class="fas fa-money-bill-wave text-primary mb-2 ui-icon-xl"></i>
                            ...
                            <div class="col-md-4 text-center mb-3">
                                <div class="p-3 bg-success bg-opacity-10 rounded">
                                    <i class="fas fa-list text-success mb-2 ui-icon-xl"></i>
                            ...
                            <div class="col-md-4 text-center mb-3">
                                <div class="p-3 bg-info bg-opacity-10 rounded">
                                    <i class="fas fa-calendar-alt text-info mb-2 ui-icon-xl"></i>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive ui-scroll-frame-md">
