...
<body class="sidebar-loading">
  <div class="app-layout">
    <!-- Sidebar -->
    <aside class="sidebar">
      <?= $this->include('partials/super-admin-sidebar') ?>
    </aside>
    ...
    <div class="main-content">
      <!-- Header -->
      <header class="header">
        <?= $this->include('partials/super-admin-header', [
          'pageTitle' => $pageTitle ?? 'Super Admin Portal',
          'pageSubtitle' => $pageSubtitle ?? 'Manage officer approvals and system administration'
        ]) ?>
      </header>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function restoreSidebarState() {
        ...
        if (forceExpand) {
          ...
          localStorage.removeItem('superAdminSidebarCollapsed');
          if (sidebar) {
            sidebar.classList.remove('collapsed');
            updateMainContentMargin(false);
          }
      ...
      if (sidebarLogo && sidebar) {
        sidebarLogo.addEventListener('click', function(e) {
          ...
          // If not collapsed, let the default link behavior proceed (navigate to portal)
        });
      }
