...
<body>
    <div class="container">
        ...
        <p>We regret to inform you that your refund request has been <strong>rejected</strong>. Please review the details below.</p>
        
        <div class="refund-box">
            <div class="refund-label">Requested Refund Amount</div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <span class="info-value"><?= esc($rejectedDate) ?></span>
            </div>
        </div>
        ...
        <div class="note-box">
            <h3 style="margin: 0 0 10px 0; color: #856404; font-size: 14px;">💬 Your Refund Reason</h3>
        ...
        <div class="note-box">
            <h3 style="margin: 0 0 10px 0; color: #856404; font-size: 14px;">📝 Admin Notes / Rejection Reason</h3>
            <p style="margin: 0; color: #333;"><?= esc($adminNotes) ?></p>
        </div>
        <?php endif; ?>

        <div style="background: #f8d7da; border: 1px solid #f5c6cb; border-radius: 5px; padding: 15px; margin: 20px 0;">
            <p style="margin: 0; color: #721c24;"><strong>Important:</strong> If you have any questions or concerns about this decision, please contact our support team for further assistance.</p>
        </div>
        ...
        <div class="footer">
            ...
            <p style="font-size: 12px; margin-top: 10px;">If you have any questions about this refund rejection, please contact our support team.</p>
        </div>
    </div>
</body>
</html>
