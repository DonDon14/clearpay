...
class _DashboardScreenState extends State<DashboardScreen> with SingleTickerProviderStateMixin {
              ...
              child: dashboardProvider.isLoading
                  ...
                  : dashboardProvider.errorMessage != null
                      ...
                      : dashboardProvider.hasData
                          ? _buildDashboardContent(dashboardProvider.dashboardData!, context)
                          : const SizedBox(),
            ),
          ],
        ),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildNavItem(Icons.payment, 'Contributions', 1, () {
                  Navigator.push(
                    context,
                ...
                _buildNavItem(Icons.request_quote, 'Requests', 2, () {
                  Navigator.push(
                    context,
  ...
  Widget _buildDashboardContent(DashboardData data, BuildContext context) {
    return Padding(
      padding: const EdgeInsets.all(20.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
